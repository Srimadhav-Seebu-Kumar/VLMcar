...
class DecisionRecord(Base):
    ...
    seq: Mapped[int] = mapped_column(Integer, nullable=False)
    heading_deg: Mapped[int] = mapped_column(Integer, nullable=False)
...
class TelemetryRecord(Base):
    ...
    last_heading_deg: Mapped[int | None] = mapped_column(Integer, nullable=True)
    last_throttle: Mapped[float | None] = mapped_column(Float, nullable=True)
